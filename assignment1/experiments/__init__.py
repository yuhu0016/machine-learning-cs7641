...
def perform_experiment(ds, ds_name, ds_readable_name, clf, clf_name, clf_label, params, timing_params=None,
    ...
    print(len(ds.features), type(ds.features))
    print(len(ds.classes), type(ds.classes))
    print(len(ds_training_x), type(ds_training_x))
    print(ds.features[0])
    print(ds_training_x[0])

    print(ds.classes[0])
    print(ds_training_y[0])
