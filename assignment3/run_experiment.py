...
if __name__ == '__main__':
    ...
    dataset1_details = {
            ...
            'best_nn_params': {'NN__activation': ['relu'], 'NN__alpha': [0.003],
                               'NN__hidden_layer_sizes': [(32, 32)], 'NN__learning_rate_init': [0.008]}
        }
    # dataset1_details = {
    ...
    dataset2_details = {
            ...
            'best_nn_params': {'NN__activation': ['relu'], 'NN__alpha': [0.01],
                               'NN__hidden_layer_sizes': [(23, 23)], 'NN__learning_rate_init': [0.016]}
    }
    if args.dataset1:
